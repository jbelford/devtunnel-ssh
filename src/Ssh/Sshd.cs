...
internal sealed class Sshd
{
    ...
    public static async Task<Sshd> PrepareAsync(int port, string clientPubKey, bool permitRootLogin = false, CancellationToken ct = default)
    {
        ...
        b.Append(permitRootLogin ? "PermitRootLogin yes\n" : "PermitRootLogin no\n");
